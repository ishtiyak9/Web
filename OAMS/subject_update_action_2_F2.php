...
if(isset($_POST['update']))
 {
   ...
   $q1=mysqli_query($conn,"UPDATE sub_tbl SET subject_code='$subjid',subject_name='$subjname',sub_credit='$subjcd',teacher_name='$tname',dept_name='$dept',semester='$semester' where subject_code='$subcode'"); //$subjid(cannot change subject_code)
