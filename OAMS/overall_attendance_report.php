			...
			<!-- <div class="main"> -->
				...
				<div class="content">
                    ...
                    <div class="text-center">
                        <hr class="team_hr team_hr_left hr_gray"/><span class="span_blog txt_darkgrey txt_orange">Overall Report</span>
					...
					// {
						...
						mysqli_select_db($conn,$dbname);
			            $veiw=mysqli_query($conn,"select * from bhup order by rn,subject asc");

			            

			            $query3=mysqli_query($conn,"Select * from attd_tbl T inner join bhup st on st.rn=T.std_id group by st.rn,T.subject");
