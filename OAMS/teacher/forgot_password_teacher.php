<?php
    ...
    if (isset($_POST["submit"])) 
    {
		...
		if (isset($_POST["username"]) && !empty($_POST["username"]) ) 
		{
			...
			$query="select * from teacher_signup_tbl where username='$username'";
			...
			if ($row["username"]==$username ) 
			{
				...
				header("location:http://localhost:8082/FINALPROJECT/teacher/update_password_teacher.php?sid={$username}");
