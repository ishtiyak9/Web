...
if(isset($_POST['submit']))
{
  ...
  if($q1)
  {
   header("location:http://localhost:8082/FINALPROJECT2/teacher/attendance_details.php");
...
<?php
		...
		$sql2="select * from sub_tbl where semester='$semester' and teacher_id='$sid' order by subject_name";
                ...
                <center>  
					...
					<div class="row">
						...
						?>
				       	...
				       	<div class="form-group">
				       		<input type="text" class="form-control2" name="<?php echo $row['id']; ?>" value="<?php echo $row['rn']; ?>" required>

				      	</div>

				    
					    <div class="form-group colour">
					    <input type="radio" value="P" name="<?php echo $row['rn']; ?>" required />Present
					    </div>
				    
					    <div class="form-group colour">
					    <input type="radio" value="A"  name="<?php echo $row['rn']; ?>" required />Absent
					    </div>
