...
if(loggedin()){
	...
	header("location:http://localhost:8082/FINALPROJECT2/teacher/student_details.php");
	}
	else
	{
...
<?php
    ...
    if (isset($_POST["submit"])) 
    {
		...
		if (isset($_POST["username"]) && !empty($_POST["username"]) && isset($_POST["password"])  && !empty($_POST["password"]) ) 
		{
			...
			$query="select * from teacher_signup_tbl where username='$username' AND password='$password'";
				...
				<div class="content">
                    ...
                    <div class="panel-body">
                        <form role="form" method="post" action=" ">
                                ...
                                <div class="loginref">
                                	<a style="float:left;" href="signup_teacher.php">New user? Register here</a>

                                	<a style="float:right;" href="forgot_password_teacher.php">Forgot Password?</a>
                                </div> 
                        </form>
                    </div>
                </div>
