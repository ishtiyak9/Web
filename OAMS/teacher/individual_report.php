  ...
  if (isset($_POST["search"])) 
    {
		...
		header("location:http://localhost:8082/FINALPROJECT2/teacher/individual_report_details.php?stid={$stid}");
...
include "header_teacher.php"; ?>
			...
			<div class="main">
				...
				<div class="content">
		            ...
		            <form action="individual_report.php" method="POST" name="reg" onSubmit="return validate()">

			          <div  class="row"> <!-- id="C" -->
				            
				        <div class="form-group">
				            <!-- <label for="name" class="l"> Student ID(*) </label><br> -->
				            <input class="form-control2" type="text" name="stid" placeholder="student id" id="sid" value="" required>
				        </div><!-- <br> -->
