...
if(isset($_POST['submit']))
{
    ...
    $username=$_POST['username'];
    $email= $_POST['email'];
    $sql1 = "SELECT * FROM teacher_signup_tbl WHERE email = '$email'";
    $result1 = mysqli_query($conn,$sql1) or die(mysqli_error());

    $sql2 = "SELECT * FROM teacher_signup_tbl WHERE username = '$username'";
    ...
    if (mysqli_num_rows($result2) > 0)
    {
      ...
      {
        header("Location: http://localhost:8082/FINALPROJECT/teacher/signup_teacher.php");
        exit;
      }
    ...
    else
    {
      ...
      $q1=mysqli_query($conn,"insert into teacher_signup_tbl values('$username','$email','$password')");
      if($q1)
      {
      ...
      http://localhost:8080/FINALPROJECT/teacher/login_teacher.php
      ...
      if($sentmail)
      {
        ...
        echo "<script type='text/javascript'>
                  ...
                  alert('Your Confirmation link Caanot Be Sent To Your Email Address');
               </script>";
      }
